...
public class ViewMiddle extends LinearLayout implements ViewBaseAction {
    ...
    private void init(Context context) {
        ...
        regionListView = (ListView) findViewById(R.id.listView);//左侧list
        plateListView = (ListView) findViewById(R.id.listView2);//右侧list
        ...
        for(int i=0;i<10;i++){
            groups.add(i+"行");//上级数据源
            LinkedList<String> tItem = new LinkedList<String>();//子数据源
            for(int j=0;j<15;j++){
                tItem.add(i+"行"+j+"列");
            }
